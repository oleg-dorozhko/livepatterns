...
function getSomePart(im, sw,sh, nw, nh)
{
	...
	var newpng = context2.getImageData(0,0,canvas2.width,canvas2.height);
...
function both_axes_plus(im)
{
	...
	//getSomePart(im, nw, nh);
		...
		var canvas2 = document.createElement("canvas");
	canvas2.width =  im.width+1;
	canvas2.height = im.height+1;
	var context2 = canvas2.getContext("2d");
	
	var result_png = context2.getImageData(0,0,canvas2.width,canvas2.height);
