...
function mod_nova_rotate3_rotate_one_xy_obj(point, mcos, msin){
           var rotated_point={};
           rotated_point.x = (point.x * mcos|0) - (point.y * msin|0);
           rotated_point.y = (point.x * msin|0) + (point.y * mcos|0);
           return rotated_point;
}

function mod_nova_rotate3_fillRectanglePro(imgData2, i0, j0, n, m, col)
{
...
function mod_nova_rotate3_rotate777(imageData,ang_rn)
{
	...
	{   
		...
		for(var x=-cx;x<cx;x++)
		{
			...
			var col = getColorArrayFromImageData(im2,x+cx,y+cy);
			
			var obj = {};
			obj.x=x;
			obj.y=y;
			obj = mod_nova_rotate3_rotate_one_xy_obj(obj, mcos,msin);
			
			obj.x=cx+obj.x;
			obj.y=cy+obj.y;
			
			
			im2 = mod_nova_rotate2_fillRectanglePro(im2, obj.x, obj.y, 1, 1, col);
