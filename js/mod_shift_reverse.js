function shift_reverse_wrapper()
{
...
function shift_reverse_imgData(im0,s)
{
	var canvas_ish_id = 'canvas0';
	var canvas_res_id = 'canvas0';
...
function __shift_reverse(im,dx,dy)
{
	...
	for (var y = 0; y < h; y+=dy)
	{
			...
			var im5 = shift_reverse_hline_left(im4);
...
function shift_reverse_hline_left(im0)
{
	var w = im0.width;
	var h = im0.height;
...
function shift_reverse2_wrapper()
{
	var canvas_ish_id = 'canvas0';
	var canvas_res_id = 'canvas0';
	var canvas = document.getElementById(canvas_ish_id);
	...
	counter--;
	document.getElementById("shift_vert_counter").value=counter;
	var im2 = __shift_reverse2(im,dx,dy);
...
function shift_reverse2_imgData(im)
{
	
	var im = __half_imageData(im);
	...
	return vortex(fill_all(im,im2));
	
	
}


function __shift_reverse2(im,dx,dy)
{
	...
	for (var x = 0; x < w; x+=dx)
	{
			...
			var im5 = shift_reverse_vline_down(im4);
			context2.putImageData(im5,x,y);
...
function shift_reverse_vline_down(im0)
{
	var w = im0.width;
	var h = im0.height;
