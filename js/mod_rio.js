...
window.addEventListener("load",function(){
	document.getElementById("rio").onclick = whenUserClickRio;
});
...
function whenUserClickRio(f) 
{
	...
	var mm = h-1;
			...
			var c1 = getColorArrayFromImageData(im, x, y);
			...
			for (var y = 0; y < h; y++) {
				...
				for (var x = 0; x < w; x++) {
						...
						var c2 = getColorArrayFromImageData(im, x, y);
						
						if(compareColors(c1,c2)==true)
						{
